...
namespace ERP {
    ...
    public partial class ERPDataSet : global::System.Data.DataSet {
        ...
        public partial class PessoasDataTable : global::System.Data.TypedTableBase<PessoasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public PessoasRow AddPessoasRow(string Nome, string CPF, string Telefone, string Email) {
...
namespace ERP.ERPDataSetTableAdapters {
    ...
    public partial class PessoasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Pessoas] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_CPF = 1 AND [CPF] IS NULL) OR ([CPF] = @Original_CPF)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pessoas] ([Nome], [CPF], [Telefone], [Email]) VALUES (@Nome, @" +
                "CPF, @Telefone, @Email);\r\nSELECT Id, Nome, CPF, Telefone, Email FROM Pessoas WHE" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Pessoas] SET [Nome] = @Nome, [CPF] = @CPF, [Telefone] = @Telefone, [Email] = @Email WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_CPF = 1 AND [CPF] IS NULL) OR ([CPF] = @Original_CPF)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT Id, Nome, CPF, Telefone, Email FROM Pessoas WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, CPF, Telefone, Email FROM dbo.Pessoas";
        ...
        public virtual int Fill(ERPDataSet.PessoasDataTable dataTable) {
        ...
        public virtual ERPDataSet.PessoasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ERPDataSet.PessoasDataTable dataTable = new ERPDataSet.PessoasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ERPDataSet.PessoasDataTable dataTable) {
        ...
        public virtual int Update(string Nome, string CPF, string Telefone, string Email, int Original_Id, string Original_Nome, string Original_CPF, string Original_Telefone, string Original_Email, int Id) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string CPF, string Telefone, string Email, int Original_Id, string Original_Nome, string Original_CPF, string Original_Telefone, string Original_Email) {
            return this.Update(Nome, CPF, Telefone, Email, Original_Id, Original_Nome, Original_CPF, Original_Telefone, Original_Email, Original_Id);
        }
    }
